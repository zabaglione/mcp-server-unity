...
public class GameManager : MonoBehaviour
{
    ...
    public void GameOver()
    {
        ...
        for (let i = 0; i < Math.min(this.options.scriptCount, scripts.length); i++) {
            ...
            const scriptPath = path.join(this.projectPath, 'Assets', 'Scripts', script.folder, `${script.name}.cs`);
...
NavMeshSettings:
  ...
  m_NavMeshData: {fileID: 0}`;
     ...
     */
    generateMaterialYAML(materialName) {
        return `%YAML 1.1
%TAG !u! tag:unity3d.com,2011:
--- !u!21 &2100000
Material:
...
//# sourceMappingURL=virtual-unity-project.js.map