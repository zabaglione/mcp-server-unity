    ...
    public string testValue = "E2E Test";
                    ...
                    },
                    {
                        ...
                        test: async () => {
                            ...
                            for (let i = 1; i <= 3; i++) {
                                await this.services.scriptService.createScript(`BatchScript${i}`, `public class BatchScript${i} : MonoBehaviour {}`);
                            }
                ...
                testCases: [
                    {
                        ...
                        test: async () => {
                            await this.services.editorScriptService.createEditorScript('E2EEditorWindow', 'editorWindow', {});
                            await this.services.editorScriptService.createEditorScript('E2ECustomEditor', 'customEditor', { targetClass: 'E2ETestScript' });
...
//# sourceMappingURL=e2e-direct-test.js.map