...
public class SnapshotTestScript : MonoBehaviour
{
        ...
        return [
            ...
            },
            {
                ...
                test: async () => {
                    ...
                    const promises = Array(10).fill(null).map((_, i) => this.harness.simulateToolCall('asset_create_script', {
                        fileName,
    ...
    printSummary() {
        ...
        // New snapshots
        const newSnapshots = this.results.filter(r => r.type === 'snapshot' && r.message?.includes('New snapshot'));
...
//# sourceMappingURL=snapshot-boundary-tests.js.map