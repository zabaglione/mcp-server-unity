...
class RegressionTests {
    ...
    async testCreateScriptInFolder() {
        await TestUtils.runMCPCommand('asset_create_script', {
            fileName: 'EnemyAI',
...
//# sourceMappingURL=regression-tests.js.map