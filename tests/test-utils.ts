...
export class TestUtils {
  static async createTestProject(basePath: string): Promise<string> {
...
public class PlayerController : MonoBehaviour
{
    ...
    await fs.writeFile(
      path.join(projectPath, 'Assets', 'Scripts', 'PlayerController.cs'),
      sampleScript
    );
  ...
  static async cleanupTestProject(projectPath: string): Promise<void> {
    try {
